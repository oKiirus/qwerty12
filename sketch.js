...
function setup() {
  ...
  left = createSprite(150, 400, 300, 2000)
  left.visible = 0

  eee = createSprite(400, 150, 2000, 300)
  eee.visible = 0

  right = createSprite(650, 400, 300, 2000)
  right.visible = 0

  bottom = createSprite(400, 650, 2000, 300)
  bottom.visible = 0
...
if(health <= 0){
  ...
  if(gameState === -1){
      ...
      textSize(35)
      text("Double tap 'r' to continue", 400, 400)
